...
<head>
    ...
    <title>Pendaftaran Data - Klinik Apotek</title>
              ...
              <tr>
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  <tr>
                    ...
                    <th width="120"><strong>No. Daftar </strong></th>
                    <th width="130"><strong>Tgl. Daftar </strong></th>
                    <th width="150"><strong>Nomor RM </strong></th>
                    <th width="174"><strong>Nama Pasien </strong></th>
                    <th width="87"><strong>Tgl. Janji </strong></th>
                    <th width="115"><strong>Jam. Janji </strong></th>
                    <th colspan="3" style="text-align: center;"><strong>Opsi</strong></th>
                  </tr>
                  <?php
                            include_once "../../../config/koneksi.php";

                            $no = 1;
                            $daftar = mysqli_query($conn, "SELECT * FROM tb_pendaftaran LEFT JOIN tb_pasien USING (no_rm) ORDER BY id_daftar");
                  ...
                  <tr>
                    ...
                    <td><?php echo $row['jam_janji']; ?></td>
                    <td width="41" align="center"><a href="pendaftaran_cetak.php?idp=<?php echo $row['id_daftar']?>" target="_blank">Cetak</a></td>
                    <td width="40" align="center"><a href="pendaftaran_delete?id=<?php echo $row['id_daftar']?>" target="_self" alt="Delete Data" onclick="return confirm('ANDA YAKIN AKAN MENGHAPUS DATA PENDAFTARAN INI ... ?')">Delete</a></td>
                  </tr>
                  <?php } } ?>
                </table></td>
              </tr>

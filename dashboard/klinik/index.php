...
<head>
    ...
    <title>Klinik Dashboard - Klinik Apotek</title>
...
<?php 
    ...
    // cek apakah yang mengakses halaman ini sudah login sebagai klinik
    if($_SESSION['level']!="klinik"){
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <!-- Topbar Navbar -->
                     <ul class="navbar-nav ml-auto">
                        ...
                        $login = mysqli_query($conn, "select * from tb_petugas WHERE id_petugas= '3'");
...
<!-- Page Heading -->
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        $total_pasien = mysqli_query($conn, "select * from tb_pasien");
                        $tp = mysqli_num_rows($total_pasien)
                        ?>
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-bottom-info  b-3 shadow h-100 py-2">
                                <div class="card-body">
                        ...
                        $total_rawat = mysqli_query($conn, "select * from tb_rawat");
                        $tr = mysqli_num_rows($total_rawat)
                        ?>
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-bottom-info  b-3 shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Rawat
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">

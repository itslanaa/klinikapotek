...
<head>
    ...
    <title>Tambah Data Dokter - Klinik Apotek</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Tambah Data Dokter<h6 class="m-0 font-weight-normal text-primary h6"></h6>
                        </div>
                        <div class="card-body">
                            <form action="action/dokter_addaksi.php" method="POST" name="formInput" onSubmit="validasi()">
                                <table class="font-weight-normal text-primary">
                                    <tr>
                                        <td>Kode Dokter</td>
                                        <td>:</td>
                                        <td><input type="text" class="form-control form-control-user ml-md-3" id="kd_dokter" name="kd_dokter" maxlength="5" required=""></td>
                                    </tr>
                                    <tr>
                                        <td>Nama Dokter</td>
                                        <td>:</td>
                                        <td><input type="text" class="form-control form-control-user ml-md-3" id="nm_dokter" name="nm_dokter" required=""></td>
                                    </tr>
                                     <tr>
                                        <td>Jenis Kelamin</td>
                                        <td>:</td>
                                    ...
                                    <tr>
                                        <td>Spesialisasi</td>
                                        <td>:</td>
                                        <td><input type="text" class="form-control form-control-user ml-md-3" id="spesialisasi" name="spesialisasi" required></td>
                                    </tr>
                                    <tr>
                                            <td>&nbsp;</td>
                                            <td>&nbsp;</td>

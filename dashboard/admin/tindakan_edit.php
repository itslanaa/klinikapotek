...
<head>
    ...
    <title>Edit Data Tindakan - Klinik Apotek</title>
                ...
                <div class="container-fluid">
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Edit Data Tindakan<h6 class="m-0 font-weight-normal text-primary h6"></h6>
                        </div>
                            <?php
                            $id = $_GET['id'];
                            $data_tindakan = mysqli_query($conn,"select * from tb_tindakan WHERE kd_tindakan='$id'")or die(mysql_error());
                            $nomor = 1;
                                while($dt = mysqli_fetch_array($data_tindakan)){
                            ?>
                            <form action="action/tindakan_updateaksi.php" method="POST" onSubmit="validasi()">
                                <table class="font-weight-normal text-primary ml-4">

                                    <tr>
                                        <td class="pt-3">Kode Tindakan</td>
                                        <td class="pt-3">:</td>
                                        <td>
                                            <input type="hidden" name="id" value="<?php echo $dt['kd_tindakan']; ?>">
                                            <input type="text" class="form-control form-control-user ml-md-3 mt-3" id="kd_tindakan" name="kd_tindakan" value="<?php echo $dt['kd_tindakan']; ?>">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Nama Tindakan</td>
                                        <td>:</td>
                                        <td><input type="text" class="form-control form-control-user ml-md-3" id="nm_tindakan" name="nm_tindakan" value="<?php echo $dt['nm_tindakan']; ?>"></td>
                                    </tr>
                                    <tr>
                                        <td>Harga</td>
                                        <td>:</td>
                                        <td><input type="text" class="form-control form-control-user ml-md-3" id="harga" name="harga" value="<?php echo $dt['harga']; ?>"></td>
                                    </tr>
                                    <tr>
                                            <td>&nbsp;</td>
                                            <td>&nbsp;</td>

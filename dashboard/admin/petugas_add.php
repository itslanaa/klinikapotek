...
<head>
    ...
    <title>Tambah Data Petugas - Klinik Apotek</title>
                ...
                <div class="container-fluid">
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Tambah Data Petugas<h6 class="m-0 font-weight-normal text-primary h6"></h6>
                        </div>
                        <div class="card-body">
                            <form action="action/petugas_addaksi.php" method="POST" onSubmit="validasi()">
                                <table class="font-weight-normal text-primary">
                                    <tr>
                                        <td>Kode Petugas</td>
                                        <td>:</td>
                                        <td><input type="text" class="form-control form-control-user ml-md-3" id="kode" name="kode" maxlength="5" required></td>
                                    </tr>
                                    <tr>
                                        <td>Nama</td>
                                        <td>:</td>
                                        <td><input type="text" class="form-control form-control-user ml-md-3" id="nama" name="nama" required></td>
                                    </tr>
                                    <tr>
                                        <td>Username</td>
                                        <td>:</td>
                                        <td><input type="text" class="form-control form-control-user ml-md-3" id="username" name="username" required></td>
                                    </tr>
                                    <tr>
                                        <td>Password</td>
                                        <td>:</td>
                                        <td><input type="password" class="form-control form-control-user ml-md-3" id="password" name="password" required></td>
                                    </tr>
                                    <tr>
                                        <td>No. Telp</td>
                                        <td>:</td>

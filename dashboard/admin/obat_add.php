...
<head>
    ...
    <title>Tambah Data Obat - Klinik Apotek</title>
                ...
                <div class="container-fluid">
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Tambah Data Obat<h6 class="m-0 font-weight-normal text-primary h6"></h6>
                        </div>
                        <div class="card-body">
                            <form action="action/obat_addaksi.php" method="POST">
                                <table class="font-weight-normal text-primary">
                                    <tr>
                                        <td>Kode Obat</td>
                                        <td>:</td>
                                        <td><input type="text" class="form-control form-control-user ml-md-3" id="kd_obat" name="kd_obat" maxlength="5" required></td>
                                    </tr>
                                    <tr>
                                        <td>Nama Obat</td>
                                        <td>:</td>
                                        <td><input type="text" class="form-control form-control-user ml-md-3" id="nm_obat" name="nm_obat" required></td>
                                    </tr>
                                        <td>Harga Modal</td>
                                        <td>:</td>
                                        <td><input type="text" class="form-control form-control-user ml-md-3" id="harga_modal" name="harga_modal" required></td>
                                    </tr>
                                    <tr>
                                        <td>Harga Jual</td>
                                        <td>:</td>
                                        <td><input type="text" class="form-control form-control-user ml-md-3" id="harga_jual" name="harga_jual" required></td>
                                    </tr>
                                    <tr>
                                        <td>Stok</td>
                                        <td>:</td>
                                        <td><input type="text" class="form-control form-control-user ml-md-3" id="stok" name="stok" required></td>
                                    </tr>
                                    <tr>
                                        <td>Keterangan</td>
                                        <td>:</td>
                                        <td><input type="text" class="form-control form-control-user ml-md-3" id="keterangan" name="keterangan" required></td>
                                    </tr>
                                    <tr>
                                            <td>&nbsp;</td>
                                            <td>&nbsp;</td>

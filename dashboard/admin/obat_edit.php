...
<head>
    ...
    <title>Edit Data Obat - Klinik Apotek</title>
                ...
                <div class="container-fluid">
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <?php
                            $id = $_GET['id'];
                            $data_obat = mysqli_query($conn,"select * from tb_obat WHERE kd_obat='$id'")or die(mysql_error());
                            $nomor = 1;
                                while($do = mysqli_fetch_array($data_obat)){
                            ?>

                            <form action="action/obat_updateaksi.php" method="POST" onSubmit="validasi()">
                                <table class="font-weight-normal text-primary">
                                    ...
                                    <tr>
                                        ...
                                        <td>:</td>
                                        <td>
                                            <input type="hidden" name="id" value="<?php echo $do['kd_obat']; ?>">
                                            <input type="text" class="form-control form-control-user ml-md-3" id="kd_obat" name="kd_obat" value="<?php echo $do['kd_obat']; ?>" required>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Nama Obat</td>
                                        <td>:</td>
                                        <td><input type="text" class="form-control form-control-user ml-md-3" id="nm_obat" name="nm_obat" value="<?php echo $do['nm_obat']; ?>" required></td>
                                    </tr>
                                    <tr>
                                        <td>Harga Modal</td>
                                        <td>:</td>
                                        <td><input type="text" class="form-control form-control-user ml-md-3" id="harga_modal" name="harga_modal" value="<?php echo $do['harga_modal']; ?>" required></td>
                                    </tr>
                                    <tr>
                                        <td>Harga Jual</td>
                                        <td>:</td>
                                        <td><input type="text" class="form-control form-control-user ml-md-3" id="harga_jual" name="harga_jual" value="<?php echo $do['harga_jual']; ?>" required></td>
                                    </tr>
                                    <tr>
                                        <td>Stok</td>
                                        <td>:</td>
                                        <td><input type="text" class="form-control form-control-user ml-md-3" id="stok" name="stok" value="<?php echo $do['stok']; ?>" required></td>
                                    </tr>
                                     <tr>
                                        <td>Keterangan</td>
                                        <td>:</td>
                                        <td><input type="text" class="form-control form-control-user ml-md-3" id="keterangan" name="keterangan" value="<?php echo $do['keterangan']; ?>" required></td>
                                    </tr>
                                    <tr>
                                            <td>&nbsp;</td>
                                            <td>&nbsp;</td>

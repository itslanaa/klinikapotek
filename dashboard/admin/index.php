...
<head>
    ...
    <title>Admin Dashboard - Klinik Apotek</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                    <?php 
                    $total_petugas = mysqli_query($conn, "select * from tb_petugas");
                    $tp = mysqli_num_rows($total_petugas)
                    ?>
                        ...
                        <?php
                        $total_dokter = mysqli_query($conn, "select * from tb_dokter");
                        $td = mysqli_num_rows($total_dokter)
                        ?>
                        <div class="col-xl-3 col-md-6 mb-4">

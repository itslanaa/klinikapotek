...
<head>
    ...
    <title>Daftar Pencarian Pasien - Klinik Apotek</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Pencarian Data Pasien</h6>
                        </div>
                        <div class="card-body">
                             <?php
include_once "../../../config/koneksi.php";
...
$row = 50;
$pageSql = "SELECT * FROM tb_pasien $filterSql";
...
<table class="table-list" width="700" border="0" cellspacing="1" cellpadding="2">
  <tr>
    ...
    <td align="center" bgcolor="#CCCCCC"><strong>Opsi</strong></td>
  </tr>
  <?php
    $mySql = "SELECT * FROM tb_pasien $filterSql ORDER BY no_rm ASC LIMIT $row";
  ...
  <tr>
    ...
    <td><?php echo $myData['no_rm']; ?></td>
    <td><?php echo $myData['nm_pasien']; ?></td>
    <td><?php echo $myData['jns_kelamin']; ?></td>
    <td><?php echo $myData['gol_darah']; ?></td>
    <td><?php echo $myData['alamat']; ?></td>
    <td width="38" align="center"><a href="pendaftaran_add.php?id=<?php echo $myData['no_rm']; ?>" target="_self" alt="Daftar">Daftar</a></td>
  </tr>
  <?php } ?>
  <tr>
    ...
    for ($h = 1; $h <= $max; $h++) {
        $list[$h] = $row * $h - $row;
        echo " <a href='?Pencarian_Pasien&hal=$list[$h]&KeyWord=$dataCari'>$h</a> ";
    }
    ?></td>
  </tr>
</table>

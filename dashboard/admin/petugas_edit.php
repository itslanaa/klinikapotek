                ...
                <div class="container-fluid">
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Edit Data Petugas<h6 class="m-0 font-weight-normal text-primary h6"></h6>
                        </div>
                        <div class="card-body">
                            <?php
                            $id = $_GET['id'];
                            $data_petugas = mysqli_query($conn,"select * from tb_petugas WHERE id_petugas='$id'")or die(mysql_error());
                            $nomor = 1;
                                while($dp = mysqli_fetch_array($data_petugas)){
                            ?>

                            <form action="action/petugas_updateaksi.php" method="POST" onSubmit="validasi()">
                                <table class="font-weight-normal text-primary ml-2">
                                    ...
                                    <tr>
                                        ...
                                        <td>:</td>
                                        <td>
                                            <input type="hidden" name="id" value="<?php echo $dp['id_users']; ?>">
                                            <input type="text" class="form-control form-control-user ml-md-3" id="kode" name="kode" value="<?php echo $dp['kd_petugas']; ?>" required>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Nama</td>
                                        <td>:</td>
                                        <td><input type="text" class="form-control form-control-user ml-md-3" id="nama" name="nama" value="<?php echo $dp['nama']; ?>" required></td>
                                    </tr>
                                    <tr>
                                        <td>Username</td>
                                        <td>:</td>
                                        <td><input type="text" class="form-control form-control-user ml-md-3" id="username" name="username" value="<?php echo $dp['username']; ?>" required></td>
                                    </tr>
                                    <tr>
                                        <td>Password</td>
                                        <td>:</td>
                                        <td><input type="password" class="form-control form-control-user ml-md-3" id="password" name="password" value="" required></td>
                                    </tr>
                                    <tr>
                                        <td>No. Telp</td>
                                        <td>:</td>
                                        <td><input type="text" class="form-control form-control-user ml-md-3" id="no_telp" name="no_telp" value="<?php echo $dp['no_telp']; ?>" required></td>
                                    </tr>
                                    <tr>
                                        <td>level</td>
                                        <td>:</td>
                                        <td>
                                            <select class="form-control form-control-user ml-md-3" id="level" name="level" required>
                                                <option value="<?php echo $dp['level']; ?>" >-- Pilih --</option>

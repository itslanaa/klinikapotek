...
<head>
    ...
    <title>Edit Data Dokter - Klinik Apotek</title>
                ...
                <div class="container-fluid">
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Edit Data Dokter<h6 class="m-0 font-weight-normal text-primary h6"></h6>
                        </div>
                            <?php
                            $id = $_GET['id'];
                            ...
                            ?>
                            <form action="action/dokter_updateaksi.php" method="POST" onSubmit="validasi()">
                                <table class="font-weight-normal text-primary ml-4">

                                    <tr>
                                        <td class="">Kode Dokter</td>
                                        <td class="">:</td>
                                        <td>
                                            <input type="hidden" name="id" value="<?php echo $dd['kd_dokter']; ?>">
                                            <input type="text" class="form-control form-control-user ml-md-3" id="kd_dokter" name="kd_dokter" value="<?php echo $dd['kd_dokter']; ?>" required>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Nama Dokter</td>
                                        <td>:</td>
                                        <td><input type="text" class="form-control form-control-user ml-md-3" id="nm_dokter" name="nm_dokter" value="<?php echo $dd['nm_dokter']; ?>" required></td>
                                    </tr>
                                    <tr>
                                        <td>Jenis Kelamin</td>
                                        <td>:</td>
                                        <td>
                                            <select class="form-control form-control-user ml-md-3" id="jns_kelamin" name="jns_kelamin" required>
                                                <option value="<?php echo $dd['jns_kelamin']; ?>">-- Pilih --</option>
                                    ...
                                    <tr>
                                        <td>Tempat Lahir</td>
                                        <td>:</td>
                                        <td><input type="text" class="form-control form-control-user ml-md-3" id="tempat_lahir" name="tempat_lahir" value="<?php echo $dd['tempat_lahir']; ?>" required></td>
                                    </tr>
                                    <tr>
                                        <tr>
                                        <td>Tanggal Lahir</td>
                                        <td>:</td>
                                        <td><input type="date" class="form-control form-control-user ml-md-3" id="tanggal_lahir" name="tanggal_lahir" value="<?php echo $dd['tanggal_lahir']; ?>" required></td>
                                    </tr>
                                     <tr>
                                        <tr>
                                        <td>Alamat</td>
                                        <td>:</td>
                                        <td><input type="text" class="form-control form-control-user ml-md-3" id="alamat" name="alamat" value="<?php echo $dd['alamat']; ?>" required></td>
                                    </tr>
                                     <tr>
                                        <tr>
                                        <td>No. Telp</td>
                                        <td>:</td>
                                        <td><input type="text" class="form-control form-control-user ml-md-3" id="no_telp" name="no_telp" value="<?php echo $dd['no_telp']; ?>" required></td>
                                    </tr>
                                     <tr>
                                        <tr>
                                        <td>Spesialisasi</td>
                                        <td>:</td>
                                        <td><input type="text" class="form-control form-control-user ml-md-3" id="spesialisasi" name="spesialisasi" value="<?php echo $dd['spesialisasi']; ?>" required></td>
                                    </tr>
                                            <td>&nbsp;</td>
                                            <td>&nbsp;</td>
                                            <td>

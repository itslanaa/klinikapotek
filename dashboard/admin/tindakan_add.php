...
<head>
    ...
    <title>Tambah Data Tindakan - Klinik Apotek</title>
                ...
                <div class="container-fluid">
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Tambah Data Tindakan<h6 class="m-0 font-weight-normal text-primary h6"></h6>
                        </div>
                        <div class="card-body">
                            <form action="action/tindakan_addaksi.php" method="POST" onSubmit="validasi()">
                                <table class="font-weight-normal text-primary">
                                    <tr>
                                        <td>Kode Tindakan</td>
                                        <td>:</td>
                                        <td><input type="text" class="form-control form-control-user ml-md-3" id="kd_tindakan" name="kd_tindakan" maxlength="5"></td>
                                    </tr>
                                    <tr>
                                        <td>Nama Tindakan</td>
                                        <td>:</td>
                                        <td><input type="text" class="form-control form-control-user ml-md-3" id="nm_tindakan" name="nm_tindakan"></td>
                                    </tr>
                                    <tr>
                                        <td>Harga</td>
                                        <td>:</td>
                                        <td><input type="text" class="form-control form-control-user ml-md-3" id="harga" name="harga"></td>
                                    </tr>
                                    <tr>
                                            <td>&nbsp;</td>
                                            <td>&nbsp;</td>
